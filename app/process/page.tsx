    ...
    <>
          ...
          <div className="relative">
            ...
            <div className="space-y-3">
              {processSteps.map((step, i) => (
                <div
                  key={step.step}
                  className="relative flex gap-3 md:gap-5 animate-fade-up"
                ...
                >
                  ...
                  <div className="flex-1 bg-white rounded-2xl p-4 md:p-5 border border-border shadow-xl card-hover card-glow shine-hover">
      ...
      <PageSection variant="pattern">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="hero-gradient-static rounded-3xl p-6 md:p-8 text-white relative overflow-hidden shadow-2xl">
